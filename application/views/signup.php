			...
			<div class="row">
				...
				<?php
				  ########## Google Settings.. Client ID, Client Secret from https://cloud.google.com/console #############
					...
					<button class="btn-google">
						<i class="fa fa-google-plus-square fa-2x"></i> <span>Access With Google</span>
					</button>
					</a>
					<a href="<?php echo site_url('social/facebook'); ?>">
					<button class="btn-facebook">
						<i class="fa fa-facebook-square fa-2x"></i> <span>Access With Facebook</span>
					</button>
					</a>
					<button class="btn-twitter">
						<i class="fa fa-linkedin-square fa-2x"></i> <span>Access With LinkedIn</span>
					</button>
				...
				<div class="col-sm-6">
					<div id="login-form" class="login-form">
						...
						<div><input type="checkbox" id="remember-me"/> Remember Me</div><br>
